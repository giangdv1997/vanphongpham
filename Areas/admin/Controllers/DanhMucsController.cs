...
namespace Nhom1_VanPhongPham.Areas.admin.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDanhMuc,TenDanhMuc,MaCha")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDanhMuc,TenDanhMuc,MaCha")] DanhMuc danhMuc)
        {
            if (ModelState.IsValid)
            {
